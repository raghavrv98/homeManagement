...
const PersonalExpense = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      setLoading(true);
      try {
        const response = await fetch(`${API_URL}/user/raghav/personalExpense`, {
          method: "POST",
          headers: {
        ...
        if (response.ok) {
          alert("Personal entry saved successfully");
          setFormData({
            name: "",
            cost: "",
  ...
  return (
    <>
      <Header backLink="/home/money" title="Personal Expense Entry" />

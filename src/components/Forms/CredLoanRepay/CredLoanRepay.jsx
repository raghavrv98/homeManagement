...
const CredLoanRepay = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      setLoading(true);
      try {
        const response = await fetch(`${API_URL}/user/raghav/credLoanRepay`, {
          method: "POST",
          headers: {
  ...
  return (
    <>
      <Header backLink={"/home/money"} title="Cred Loan Repay" />
      <div className="container">
        <form className="form" onSubmit={handleSubmit}>
          <Typography variant="h5" align="center" gutterBottom>
            Cred Loan Repay Entry
          </Typography>
